...
const WelcomeScreen: React.FC = () => {
  ...
  return (
    <div 
      className="relative flex h-full w-full flex-col items-center justify-center p-6 bg-sage-gradient dark:bg-background-dark overflow-hidden" 
    >
      ...
      <div className="absolute bottom-12 left-0 w-full flex flex-col items-center justify-center space-y-4">
        <div 
