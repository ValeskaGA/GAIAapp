    ...
    <div className="flex flex-col h-full bg-background-light dark:bg-background-dark">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-6 pb-24">
        <div className="pt-4 pb-6">
          ...
          <h1 className="text-text-main dark:text-text-dark-main text-[32px] font-bold leading-[1.2] mb-4">Tu espacio seguro comienza con confianza</h1>
          <p className="text-text-secondary dark:text-text-dark-secondary text-[15px] leading-relaxed">Antes de comenzar tu viaje, queremos ser totalmente transparentes sobre cómo funciona GAIA.</p>
        </div>
